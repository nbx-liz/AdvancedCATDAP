...
def main():
    ...
    # Launch WebView with EdgeChromium (WebView2)
    ...
    def gc_janitor(window):
        """Placeholder - GC janitor disabled due to compatibility issues"""
        pass
    ...
    try:
        ...
        # Start webview with EdgeChromium (WebView2)
        logger.info("Starting with EdgeChromium backend...")
